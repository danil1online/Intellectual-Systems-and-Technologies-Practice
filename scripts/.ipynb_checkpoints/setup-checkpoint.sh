...
# ============================================
print_header "ШАГ 2/7: Настройка LLM для ИИ-Ментора"
...
# ШАГ 3: LLM для CI/CD
# ============================================
print_header "ШАГ 3/7: Настройка LLM для CI/CD"
...
# ============================================
print_header "ШАГ 4/7: Генерация паролей"
...
# ============================================
print_header "ШАГ 5/7: SSH-ключ для GitLab Runner"
...
# ШАГ 6: Запись .env
# ============================================
print_header "ШАГ 6/7: Генерация конфигурации"
...
echo ""
echo -e "  ${BOLD}GitLab:${NC}       http://localhost:80"
