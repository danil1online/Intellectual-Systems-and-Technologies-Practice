...
### 📌 Создание бота
  ...
  ```
  - Создаем собственную учетную запись – нового бота, как это указано в Приложении 2 (дополнительно см. ["Step 2: Text /newbot to BotFather"](https://www.instructables.com/Set-up-Telegram-Bot-on-Raspberry-Pi/)). 
