...
## Цель работы
Настроить рабочее окружение: регистрация в Keycloak, настройка SSH-ключей, первый вход в JupyterHub.
...
> ✅ Ваша учётная запись создана в Keycloak. С этими же данными вы можете войти в GitLab и JupyterHub.
