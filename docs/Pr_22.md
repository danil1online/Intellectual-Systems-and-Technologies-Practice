# Практическая работа №22: Метрики оценки качества классификации изображений. 4 часа  
...
- аналогично создать в `Pr_22` файл `LLM_Help.ipynb` (для задания уточняющих вопросов, если необходимо, см. примеры работы с данным функционалом в [разделе LLM_Help.ipynb](#-llm_helpipynb)
