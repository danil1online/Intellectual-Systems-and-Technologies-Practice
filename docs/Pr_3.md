...
3. Сохраните ноутбук как `Pr_3_<группа>_<номер>.ipynb`
...
| Критерий | Баллы |
|----------|-------|
| Функции: параметры, *args, **kwargs, lambda | 2 |
| Область видимости: global, nonlocal | 1 |
| map/filter/reduce: применение | 2 |
| Классы: __init__, методы, self | 3 |
| Наследование: super(), переопределение | 1 |
| Декораторы: создание и применение | 1 |
| **Итого** | **10** |
