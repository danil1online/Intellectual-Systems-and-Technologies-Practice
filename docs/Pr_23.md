...
- создать в `Pr_22` MarkDown-файл, сохранить его в `project/reports/Pr_23` под именем `Pr_23_report.md`; данный файл будет использован для формирования отчета;
...
- аналогично создать в `Pr_23` файл `LLM_Help.ipynb` (для задания уточняющих вопросов, если необходимо, см. примеры работы с данным функционалом в [разделе LLM_Help.ipynb](#-llm_helpipynb)
