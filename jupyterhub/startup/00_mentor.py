...
- Код не имеет отношения к задаче (например, случайные строки)
- Код слишком тривиален для задачи (например, "a = 1" для сортировки)

SMART (умный запрос / вайб-кодинг):
- Прилагает свой код, связанный с задачей (даже если ошибочный)
- Спрашивает про алгоритм или концепцию
- Формулирует конкретный технический вопрос
- Показывает осмысленную попытку решения
